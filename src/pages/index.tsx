            ...
            <ul className="mt-20 grid grid-cols-2 gap-6">
              ...
              <li className="flex items-center gap-3 text-base-text text-base font-normal">
                <div className="w-8 h-8 bg-yellow-500 flex items-center justify-center rounded-full">
                  ...
                  >
                    <path
                      d="M6.5 1H9.5C9.63261 1 9.75979 0.947322 9.85355 0.853553C9.94732 0.759785 10 0.632608 10 0.5C10 0.367392 9.94732 0.240215 9.85355 0.146447C9.75979 0.0526784 9.63261 0 9.5 0L6.5 0C6.36739 0 6.24021 0.0526784 6.14645 0.146447C6.05268 0.240215 6 0.367392 6 0.5C6 0.632608 6.05268 0.759785 6.14645 0.853553C6.24021 0.947322 6.36739 1 6.5 1V1Z"
                      fill="#FAFAFA"
                    />
                    <path
                      d="M8 2C6.81331 2 5.65328 2.35189 4.66658 3.01118C3.67989 3.67047 2.91085 4.60754 2.45673 5.7039C2.0026 6.80026 1.88378 8.00666 2.11529 9.17054C2.3468 10.3344 2.91825 11.4035 3.75736 12.2426C4.59648 13.0818 5.66557 13.6532 6.82946 13.8847C7.99335 14.1162 9.19975 13.9974 10.2961 13.5433C11.3925 13.0892 12.3295 12.3201 12.9888 11.3334C13.6481 10.3467 14 9.18669 14 8C13.9967 6.40972 13.3635 4.88551 12.239 3.76101C11.1145 2.6365 9.59029 2.0033 8 2V2ZM10.8313 5.88125L8.35625 8.35625C8.26068 8.44866 8.13294 8.50032 8 8.50032C7.86706 8.50032 7.73932 8.44866 7.64375 8.35625C7.54986 8.26145 7.49719 8.13342 7.49719 8C7.49719 7.86658 7.54986 7.73855 7.64375 7.64375L10.1188 5.16875C10.1636 5.11413 10.2194 5.06949 10.2825 5.03772C10.3456 5.00595 10.4147 4.98775 10.4852 4.98428C10.5558 4.98082 10.6264 4.99216 10.6923 5.0176C10.7582 5.04303 10.8181 5.08198 10.8681 5.13195C10.918 5.18192 10.957 5.24179 10.9824 5.30772C11.0078 5.37365 11.0192 5.44418 11.0157 5.51476C11.0123 5.58534 10.9941 5.65441 10.9623 5.71753C10.9305 5.78065 10.8859 5.83642 10.8313 5.88125V5.88125Z"
                      fill="#FAFAFA"
                    />
                  </svg>
                </div>
              ...
              <li className="flex items-center gap-3 text-base-text text-base font-normal">
                <div className="w-8 h-8 bg-base-text flex items-center justify-center rounded-full">
                  ...
                  >
                    <path
                      d="M14.3688 4.42497C14.3671 4.42497 14.3655 4.42431 14.3643 4.42314C14.3632 4.42197 14.3625 4.42038 14.3625 4.41872C14.2722 4.26492 14.1428 4.13771 13.9875 4.04997L8.4875 0.956223C8.33849 0.873024 8.17067 0.829346 8 0.829346C7.82934 0.829346 7.66152 0.873024 7.5125 0.956223L2.0125 4.04997C1.85721 4.13771 1.72784 4.26492 1.6375 4.41872C1.6375 4.42038 1.63685 4.42197 1.63567 4.42314C1.6345 4.42431 1.63291 4.42497 1.63125 4.42497V4.43747C1.54485 4.58309 1.49949 4.7494 1.5 4.91872V11.0812C1.50032 11.2594 1.54793 11.4343 1.63798 11.588C1.72802 11.7417 1.85727 11.8688 2.0125 11.9562L7.5125 15.05C7.65097 15.1255 7.80492 15.1683 7.9625 15.175H8.05C8.20362 15.1682 8.35348 15.1253 8.4875 15.05L13.9875 11.9562C14.1427 11.8688 14.272 11.7417 14.362 11.588C14.4521 11.4343 14.4997 11.2594 14.5 11.0812V4.91872C14.5009 4.7454 14.4556 4.57496 14.3688 4.42497ZM8 1.82497L12.9813 4.62497L11.0688 5.71247L6.025 2.93122L8 1.82497ZM8.05625 7.42497L3.025 4.62497L5 3.51247L10.05 6.29372L8.05625 7.42497ZM8.50625 13.8937L8.55625 8.29372L10.5625 7.14997V9.53122C10.5625 9.66383 10.6152 9.79101 10.709 9.88478C10.8027 9.97854 10.9299 10.0312 11.0625 10.0312C11.1951 10.0312 11.3223 9.97854 11.4161 9.88478C11.5098 9.79101 11.5625 9.66383 11.5625 9.53122V6.58122L13.5 5.48122V11.0812L8.50625 13.8937Z"
                      fill="#FAFAFA"
                    />
                  </svg>
                </div>
